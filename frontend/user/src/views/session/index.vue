<template>
  <div id="session">
    ...
    <div id="r-main">
      <communication :sonData="sonData"></communication>
    </div>
  </div>
</template>
  ...
  data() {
    return {
      ...
      arr: [
        {
          name: "官方小助手",
          avatar: "../../../static/images/session/助手.png",
          status: "官方",
          info: "官方小助手",
          lastdate: "昨天",
        ...
        {
          name: "心理健康测试1群",
          avatar: "../../../static/images/session/团队.png",
          status: "团队",
          ...
          mesData: [
            {
              avatar: "../../../static/images/session/文艺大叔.png",
              name: "Mr.茂密森林",
              status: "老师",
              message:
                "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Delectus nam incidunt, eos beatae amet porro quod nisi commodi, corrupti dolorem repudiandae quibusdam, fugiat corporis pariatur inventore nihil placeat explicabo? Cupiditate?",
            ...
            {
              avatar: "../../../static/images/session/女孩.png",
              name: "小翠",
              status: "班花",
              message:
                "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Delectus nam incidunt, eos beatae amet porro quod nisi commodi, corrupti dolorem repudiandae quibusdam, fugiat corporis pariatur inventore nihil placeat explicabo? Cupiditate?",
            ...
            {
              avatar: "../../../static/images/session/忍者.png",
              name: "塔塔开",
              status: "学生",
              message:
                "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Delectus nam incidunt, eos beatae amet porro quod nisi commodi, corrupti dolorem repudiandae quibusdam, fugiat corporis pariatur inventore nihil placeat explicabo? Cupiditate?",
        ...
        },
        {
          ...
          mesData: [
            {
              avatar: "../../../static/images/session/宇航员.png",
              name: "许周样",
              status: "小公举",
              message:
                "Lorem ipsum dolor sit amet consectetur, adipisicing elit. Delectus nam incidunt, eos beatae amet porro quod nisi commodi, corrupti dolorem repudiandae quibusdam, fugiat corporis pariatur inventore nihil placeat explicabo? Cupiditate?",
        ...
        {
          name: "西北工业大学夺牌小队",
          avatar: "../../../static/images/session/金牌.png",
          status: "团体",
...
#session #l-nav #create .box:hover {
...
#session #l-nav #top-nav #tool:hover {
...
#session #l-nav #list .el-menu-vertical-demo {
  border-right: none;
}
#session #l-nav #list .item {
  transition: 0.5s;
  margin: 0;
  padding: 0 !important;
...
#session #l-nav #list .item .info .box-header {
  box-sizing: border-box;
  width: 100%;
  height: 55%;
  /* margin-top:15px; */
...
#session #l-nav #list .item .info .box-header .date {
  align-self: center;
  box-sizing: border-box;
  line-height: 16px;
  font-size: 12px;
